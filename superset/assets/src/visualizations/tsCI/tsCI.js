...
function tsCI(element, props) {
  ...
  //element.innerHTML = '';
  element.innerHTML = '<div id="tsCIChart"></div>';
  ...
  /*const chart = d3_timeseries()
              .addSerie(data.slice(0,60),{x:eval('"'+colNames[2]+'"'),y:eval('"'+colNames[3]+'"')},{interpolate:'linear',color:"#a6cee3",label:"value"})
              .addSerie(data.slice(50),
              {x:eval('"'+colNames[2]+'"'),y:eval('"'+colNames[3]+'"'),ci_up:eval('"'+colNames[4]+'"'),ci_down:eval('"'+colNames[5]+'"')},
              {interpolate:'monotone',dashed:true,color:"#a6cee3",label:"prediction"})
              .width(width) */

  const chart = d3_timeseries()
    .addSerie(matrix.slice(0,60),{x:eval('"'+colNames[2]+'"'),y:eval('"'+colNames[3]+'"')},{interpolate:'linear',color:"#a6cee3",label:"value"})
    .addSerie(matrix.slice(50),
          {x:eval('"'+colNames[2]+'"'),y:eval('"'+colNames[3]+'"'),ci_up:eval('"'+colNames[4]+'"'),ci_down:eval('"'+colNames[5]+'"')},
          {interpolate:'monotone',dashed:true,color:"#a6cee3",label:"prediction"})
    .width(820)
...
tsCI.displayName = 'tsCI';
tsCI.propTypes = propTypes;
