...
export const controls = {
  ...
  plot_height: {
    ...
    renderTrigger: true,
    isInt: true,
    default: `${window.innerHeight}`-180,
    description: t('生成的图片高度'),
  },
  statistic_type: {
    type: 'SelectControl',
    label: t('统计方式'),
    ...
    description: t('mean：均值曲线，95%置信区间'+
      'median：中值曲线，5/95和25/75分位数'),
  },
  ...
  timeVariation_type: {
    ...
    description: t('全部：小时、星期、月际变化全部展示。'+
      '小时：24小时的变化情况。'+
      '星期：一周内7天的变化情况。'+
      '星期+小时：一周内7天的24小时变化。'+
      '月际：12各月份的变化。'),
  ...
  metric_3: {
    ...metric,
    label: t('Value Metric'),
    clearable: true,
    description: t('Choose a metric for pollutant'),
  },
