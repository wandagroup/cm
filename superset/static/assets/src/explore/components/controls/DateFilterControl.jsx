...
const RELATIVE_TIME_OPTIONS = Object.freeze({
  LAST: 'Last',
  NEXT: 'Next',});
const RELATIVE_TIME_OPTIONS_CN = {'Last': '过去', 'Next': '未来'};
const COMMON_TIME_FRAMES = [
  ...
  'Last year',
  'No filter',];
const COMMON_TIME_FRAMES_CN = {'Last day': '过去一天', 'Last week': '上周', 'Last month': '过去一月', 'Last quarter': '过去一季度', 'Last year': '过去一年', 'No filter': '不限'};
const TIME_GRAIN_OPTIONS = ['seconds', 'minutes', 'hours', 'days', 'weeks', 'months', 'years'];
const TIME_GRAIN_OPTIONS_CN = {'seconds': '秒', 'minutes': '分钟', 'hours': '小时', 'days': '天', 'weeks': '周', 'months': '月', 'years': '年'};
...
function getStateFromCommonTimeFrame(value) {
  ...
  return {
    tab: TABS.DEFAULTS,
    type: TYPES.DEFAULTS,
    common: COMMON_TIME_FRAMES_CN[value],
                  ...
                  <div className="clearfix centered" style={{ marginTop: '12px' }}>
                    <div style={{ width: '60px', marginTop: '-4px' }} className="input-inline">
                      <DropdownButton
                        ...
                        title={RELATIVE_TIME_OPTIONS_CN[this.state.rel]}
                        onFocus={this.setTypeCustomRange}
                      >
                        <MenuItem
                          onSelect={value => this.setCustomRange('rel', value)}
                          key={RELATIVE_TIME_OPTIONS.LAST}
                          eventKey={RELATIVE_TIME_OPTIONS_CN[RELATIVE_TIME_OPTIONS.LAST]}
                        ...
                        <MenuItem
                          ...
                          eventKey={RELATIVE_TIME_OPTIONS_CN[RELATIVE_TIME_OPTIONS.NEXT]}
                    ...
                    <div style={{ width: '90px', marginTop: '-4px' }} className="input-inline">
                      <DropdownButton
                        ...
                        title={TIME_GRAIN_OPTIONS_CN[this.state.grain]}
                        onFocus={this.setTypeCustomRange}
                      >
                        {grainOptions}
                      </DropdownButton>
